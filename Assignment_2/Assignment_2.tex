...
%\newpage
\bigskip
\textbf{Question:10.15.2.4:} A box contains 12 balls out of which x are black. If one ball is drawn at random from the box, what is the probability that it will be a black ball? If 6 more black balls are put in the box, the probability of drawing a black ball is now double of what it was before. Find x.
\\
\\
\textbf{Solution:} 
\begin{table}[htbp]
...
\caption{Random Variable Declaration\\
 $X_1$ :before addition of 6 black balls\\
 $X_2$ :before addition of 6 black balls
}
...
The probability drawn ball is black is $\pr{X_1=1}$, which is $\frac{x}{12}$. 
\bigskip
